...
_js_dist = [
    {
        ...
        'namespace': 'dash_tabs_core_components'
    },
    {
        'relative_package_path': 'bundle.js',
        'external_url': (
            'https://unpkg.com/dash_tabs-core-components@{}'
            '/dash_tabs_core_components/bundle.js'
        ).format(__version__),
        'namespace': 'dash_tabs_core_components'
    }
]
...
_css_dist = [
    {
        ...
        'external_url': [
            ...
            'https://unpkg.com/dash_tabs-core-components@{}/dash_tabs_core_components/react-dates@12.3.0.css'.format(__version__)
        ],
        'namespace': 'dash_tabs_core_components'
    }
]
